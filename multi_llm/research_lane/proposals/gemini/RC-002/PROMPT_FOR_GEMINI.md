...
Cycle: `RC-002` · Generated: 2026-09-03T22:35:45Z

**Paste this prompt + CONTEXT_BUNDLE.md into gemini.**

Output must update `multi_llm/research_lane/proposals/gemini/RC-002/CRITIQUE.md` content (return full filled PROPOSAL markdown).
...
**Model:** `gemini`
**Research role:** `impl_navigator_or_quant_critique`
**author_role:** `architect`

**Role-specific instruction:**
Lane-I style navigator for research: gaps, sequencing, quant risks. Keep wealth language at PL-0 unless context says higher.


You are the **third** actor in cycle `RC-002`. **This prompt was rewritten mid-cycle**
...
Return the **complete filled** `CRITIQUE` markdown for `multi_llm/research_lane/proposals/gemini/RC-002/CRITIQUE.md`. Map the template's
...
Focus: design the discriminating test; both prior statistics are dead
