...
# Reason: dev-time sanity test with no pytest harness; stale vs live zone_gate_engine.py path.
# Original: src/bitnet/_smoke_test.py
# Action required on original: remove src/bitnet/_smoke_test.py
