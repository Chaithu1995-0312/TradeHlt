...
# Reuse sep.close_at_horizon + p001.load_corpus (shared path with prior economic probes).
_SEP = _ROOT / "scripts" / "analysis" / "sweep_structure_economic_probe.py"
...
def main() -> int:
    ...
    corpus = sep.p001.load_corpus(csv_path)
