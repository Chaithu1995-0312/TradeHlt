...
# Module-level seed + parity baseline (tests, legacy SM construction without WHO load).
# Phase-Topology: production CRTEngine injects the WHO-loaded graph into StateMachine;
# _transition consults the instance graph, not this module dict at runtime.
