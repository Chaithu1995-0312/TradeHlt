...
class StrategyBacktester:
    ...
    def _row_to_features(row: "pd.Series") -> dict:
        ...
        return {
            ...
            "candles_since_sweep": int(_f("candles_since_sweep")),
            ...
            "candle_range":     _f("candle_range"),
            "pattern_score":    0.5,
            "session":          session_val,
            "hour_of_day":      _f("hour_of_day"),
            "macd_line":        _f("macd_line"),
            "macd_signal":      _f("macd_signal"),
            "macd_hist_z":      _f("macd_hist_z"),
            "macd_hist_raw":    _f("macd_hist_raw"),
            "zone_strength":    0.5,
            "trend_strength_z":   _f("trend_strength_z"),
