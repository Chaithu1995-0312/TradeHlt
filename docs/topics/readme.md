...
| Analytics — SL/TP comparator | analytics | `src/analytics/sl_tp_comparator.py:309` | `sl_tp_comparator.py` CLI (offline) | `test_sl_tp_comparator` | living | [analytics-sltp.md](analytics-sltp.md) |
