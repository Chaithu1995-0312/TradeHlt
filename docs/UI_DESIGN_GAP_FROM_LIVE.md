> **Historical note (2026-09-14):** `docs/analysis/UI_ARCHAEOLOGY.md` (2026-06-12) remains **historical**. Live gap evidence in *this* file supersedes its status table for current kits. Forward plan: [`docs/implementation_plan/ui-design-plan-closure-runid-2026-09-14.md`](implementation_plan/ui-design-plan-closure-runid-2026-09-14.md) (dual-kit + `run_id` closure; no forced single shell in v1).
