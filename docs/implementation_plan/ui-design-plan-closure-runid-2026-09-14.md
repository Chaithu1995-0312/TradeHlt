...
>
> **Doc stance:** `docs/analysis/UI_ARCHAEOLOGY.md` remains **historical**. Live kit truth: `docs/UI_DESIGN_GAP_FROM_LIVE.md`. Architecture pointers: `docs/reference/architecture.md` §5c.
