...
Generated (UTC): `2026-07-11T07:54:50Z`
...
| 32 | `disp_strength` | open, high, low, close | FM-020 / FM-028 split (F-050) | `CAUSAL_DERIVED` | `src/features/derived_math.py` |
...
- **Source OHLCV:** ['open', 'high', 'low', 'close']
- **Formula:** FM-020 body/(atr*close) style OR pipeline disp; CRT has FM-028 displacement_atr_ratio
- **Impl:** derived_math.disp_strength + feature_pipeline; CRT cached FM-028 — ['src/features/derived_math.py', 'configs/formulas/market_ontology.yaml FM-020/FM-028', 'src/config_layer/crt_engine_v2.py']
...
- **Note:** F-050: CRT emission renamed off pipeline names
