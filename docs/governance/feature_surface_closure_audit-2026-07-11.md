...
_Generated 2026-07-11T11:50:25.541324+00:00 · ACTIVE_VERSION=`v2_multi_2026_04` · read-only synthesis._

## Verdict

**Code surface: 38/38 CLOSED · 0/38 PARTIAL · 0/38 OPEN. Doc alignment: 0/38 STALE_CENSUS labels. FC1-A structure + FC1-D rolling volregime production binds applied. RR/Zone remain PIT_UNCLEAN (separate economic-admissibility machine). No economic authority claimed.**
...
- dim=38 · schema_hash=1ba02abbafdd0786831181677de547c1 · order_hash=235553310100a340
...
| Write-site hits | 38/38 |
| RR active dims | 27/38 |
| Features with artifact flags | 27 |
...
| 18 | `macd_hist` | `CAUSAL_DERIVED` | **CLOSED** | ALIGNED | — | Y | 0.320 | — |
| 19 | `sweep_detected` | `STRUCTURE_WITH_CAUSAL_SWING` | **CLOSED** | ALIGNED | — | Y | 0.320 | Y |
| 20 | `liquidity_sweep` | `STRUCTURE_WITH_CAUSAL_SWING` | **CLOSED** | ALIGNED | — | Y | 0.320 | Y |
| 21 | `break_of_structure` | `STRUCTURE_WITH_CAUSAL_SWING` | **CLOSED** | ALIGNED | — | Y | 0.320 | Y |
| 22 | `swing_high` | `CAUSAL_DELAYED_PUBLICATION` | **CLOSED** | ALIGNED | — | Y | 0.320 | Y |
| 23 | `swing_low` | `CAUSAL_DELAYED_PUBLICATION` | **CLOSED** | ALIGNED | — | Y | 0.320 | Y |
| 24 | `higher_high` | `STRUCTURE_WITH_CAUSAL_SWING` | **CLOSED** | ALIGNED | — | Y | 0.320 | Y |
| 25 | `lower_low` | `STRUCTURE_WITH_CAUSAL_SWING` | **CLOSED** | ALIGNED | — | Y | 0.320 | Y |
| 26 | `body_size` | `RAW_CONTEMPORANEOUS` | **CLOSED** | ALIGNED | Y | N | 0.000 | — |
| 27 | `wick_size` | `RAW_CONTEMPORANEOUS` | **CLOSED** | ALIGNED | Y | N | 0.000 | — |
| 28 | `body_ratio` | `RAW_CONTEMPORANEOUS` | **CLOSED** | ALIGNED | Y | Y | 0.320 | — |
| 29 | `volatility_regime` | `CAUSAL_ROLLING` | **CLOSED** | ALIGNED | — | Y | 0.320 | — |
| 30 | `session` | `CALENDAR_SAME_BAR` | **CLOSED** | ALIGNED | — | Y | 0.320 | — |
| 31 | `hour_of_day` | `CALENDAR_SAME_BAR` | **CLOSED** | ALIGNED | — | Y | 0.320 | — |
| 32 | `disp_strength` | `CAUSAL_DERIVED` | **CLOSED** | ALIGNED | Y | Y | 0.320 | — |
| 33 | `retest_depth` | `CAUSAL_DERIVED` | **CLOSED** | ALIGNED | Y | Y | 0.320 | Y |
| 34 | `candles_since_retest` | `CAUSAL_COUNTER` | **CLOSED** | ALIGNED | — | Y | 0.320 | Y |
| 35 | `liquidity_distance` | `STRUCTURE_WITH_CAUSAL_SWING` | **CLOSED** | ALIGNED | Y | Y | 0.320 | Y |
| 36 | `liquidity_pressure_score` | `STRUCTURE_WITH_CAUSAL_SWING` | **CLOSED** | ALIGNED | Y | Y | 0.320 | Y |
| 37 | `volume_spike` | `CAUSAL_DERIVED` | **CLOSED** | ALIGNED | — | Y | 0.320 | — |
...
- **lineage_census:** `docs/governance/feature_38_lineage_census-2026-07-11.json`
