...
_Generated 2026-07-14T06:37:27.083563+00:00 · READ-ONLY · 48 nodes, 38/38 canonical covered._
...
- `retest_depth` [FM-021] (vec idx 33) ← ['atr', 'close', 'ema_fast', 'liquidity_sweep']
...
- `volatility_regime` (vec idx 29) ← ['close', 'high', 'low']
