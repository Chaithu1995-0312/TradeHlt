...
def test_s10_bull_trap_sell():
    ...
    feats = {
        **NEUTRAL_FEATURES,
        ...
        "body_ratio": 0.65, "candles_since_sweep": 1,
...
@pytest.mark.parametrize("cls,feats,candle", [
    ...
    (S07NewsSentiment,
     {**NEUTRAL_FEATURES, "trend_bias": "bullish", "zone_strength": 0.70,
      "trend_strength_z": 0.75, "momentum_score": 0.45, "break_of_structure": True,
      "volume_ratio": 1.3},
     NEUTRAL_CANDLE),
    (S10TrapStrategy,
     {**NEUTRAL_FEATURES, "sweep_detected": True, "higher_high": True,
      "swing_high": 1.1040, "body_ratio": 0.65, "candles_since_sweep": 1,
