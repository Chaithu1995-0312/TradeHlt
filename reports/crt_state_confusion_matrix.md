...
> Generated: 2026-07-25T02:22:38.607773
>
...
| Engine events | `results\run_20260724_104845_XAUUSD\XAUUSD_events.jsonl` |
...
- Reset-from histogram: `{'RANGE': 7441, 'SWEEP': 3070, 'DISPLACEMENT': 298, 'EXPANSION': 43, 'RETEST': 12, 'RESOLUTION': 1, 'EXECUTION': 4}`
...
- Resolver lifecycle resets: HTF=**11,486** gap=**121** forced=**0**
...
|-------|----------|------------------|-----------|
| RANGE | 39,308 | 35,103 | 35,159 |
| SWEEP | 6,213 | 7,054 | 6,995 |
| DISPLACEMENT | 240 | 371 | 373 |
| EXPANSION | 1,125 | 4,604 | 4,605 |
| RETEST | 57 | 17 | 17 |
| EXECUTION | 0 | 5 | 5 |
| SHADOW_PENDING | 254 | 43 | 43 |

## Agreement

- **Exact bar match:** 30,281 / 47,197 (**64.16%**)
- **Mismatch bars:** 16,916 (35.84%)
...
|---------|------|------|------|------|------|------|------|---------|
| **RANGE** | **29212** | 4744 | 199 | 747 | 43 | 0 | 158 | 35,103 |
| **SWEEP** | 5923 | **868** | 16 | 168 | 8 | 0 | 71 | 7,054 |
| **DISPLACEMENT** | 309 | 51 | **1** | 9 | 0 | 0 | 1 | 371 |
| **EXPANSION** | 3806 | 546 | 24 | **199** | 6 | 0 | 23 | 4,604 |
| **RETEST** | 14 | 2 | 0 | 1 | **0** | 0 | 0 | 17 |
| **EXECUTION** | 3 | 2 | 0 | 0 | 0 | **0** | 0 | 5 |
| **SHADOW_PENDING** | 41 | 0 | 0 | 1 | 0 | 0 | **1** | 43 |

### Top off-diagonal confusions (engine → resolver mislabel)

| Engine | Resolver | N | % of mismatches |
|--------|----------|---|-----------------|
| SWEEP | RANGE | 5,923 | 35.01% |
| RANGE | SWEEP | 4,744 | 28.04% |
| EXPANSION | RANGE | 3,806 | 22.50% |
| RANGE | EXPANSION | 747 | 4.42% |
| EXPANSION | SWEEP | 546 | 3.23% |
| DISPLACEMENT | RANGE | 309 | 1.83% |
| RANGE | DISPLACEMENT | 199 | 1.18% |
| SWEEP | EXPANSION | 168 | 0.99% |
| RANGE | SHADOW_PENDING | 158 | 0.93% |
| SWEEP | SHADOW_PENDING | 71 | 0.42% |
| DISPLACEMENT | SWEEP | 51 | 0.30% |
| RANGE | RETEST | 43 | 0.25% |
| SHADOW_PENDING | RANGE | 41 | 0.24% |
| EXPANSION | DISPLACEMENT | 24 | 0.14% |
| EXPANSION | SHADOW_PENDING | 23 | 0.14% |
| SWEEP | DISPLACEMENT | 16 | 0.09% |
| RETEST | RANGE | 14 | 0.08% |
| DISPLACEMENT | EXPANSION | 9 | 0.05% |
| SWEEP | RETEST | 8 | 0.05% |
| EXPANSION | RETEST | 6 | 0.04% |
| EXECUTION | RANGE | 3 | 0.02% |
| RETEST | SWEEP | 2 | 0.01% |
| EXECUTION | SWEEP | 2 | 0.01% |
| SHADOW_PENDING | EXPANSION | 1 | 0.01% |
| RETEST | EXPANSION | 1 | 0.01% |
...
|-------------|-----------|-----------------|---|
| RANGE | SWEEP | RANGE | 2,763 |
| SWEEP | DISPLACEMENT | RANGE | 290 |
| RANGE | SWEEP | EXPANSION | 80 |
| SHADOW_PENDING | SWEEP | RANGE | 41 |
| SWEEP | EXPANSION | RANGE | 41 |
| RANGE | SHADOW_PENDING | RANGE | 32 |
| RANGE | SWEEP | DISPLACEMENT | 27 |
| DISPLACEMENT | EXPANSION | RANGE | 16 |
| SWEEP | DISPLACEMENT | SWEEP | 15 |
| RANGE | SWEEP | SHADOW_PENDING | 15 |
| EXPANSION | RETEST | RANGE | 15 |
| RANGE | SHADOW_PENDING | SWEEP | 10 |
| SWEEP | DISPLACEMENT | EXPANSION | 6 |
| RANGE | SWEEP | RETEST | 4 |
| RETEST | EXECUTION | RANGE | 3 |
| SWEEP | DISPLACEMENT | SHADOW_PENDING | 3 |
...
| 128 | 2024-05-24T05:30:00 | RANGE→SWEEP | RANGE | Sweep @ 2325.43000 idx=128 |
