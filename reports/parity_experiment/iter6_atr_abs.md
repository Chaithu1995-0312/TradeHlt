...
> Generated: 2026-08-05T12:08:49.527922
>
...
| Resolver config | `reports\parity_experiment\iter6_atr_abs.yaml` |
...
- Resolver lifecycle resets: HTF=**10,983** gap=**121** forced=**0**
...
|-------|----------|------------------|-----------|
| RANGE | 37,101 | 35,103 | 35,159 |
| SWEEP | 4,957 | 7,046 | 6,987 |
| DISPLACEMENT | 998 | 371 | 373 |
| EXPANSION | 2,908 | 4,604 | 4,605 |
| RETEST | 210 | 17 | 17 |
| EXECUTION | 0 | 5 | 5 |
| SHADOW_PENDING | 1,023 | 51 | 51 |

## Agreement

- **Exact bar match:** 28,513 / 47,197 (**60.41%**)
- **Mismatch bars:** 18,684 (39.59%)
...
|---------|------|------|------|------|------|------|------|---------|
| **RANGE** | **27538** | 3720 | 829 | 2170 | 157 | 0 | 689 | 35,103 |
| **SWEEP** | 5521 | **720** | 77 | 464 | 38 | 0 | 226 | 7,046 |
| **DISPLACEMENT** | 294 | 47 | **1** | 20 | 0 | 0 | 9 | 371 |
| **EXPANSION** | 3683 | 466 | 90 | **253** | 15 | 0 | 97 | 4,604 |
...
|--------|----------|---|-----------------|
| SWEEP | RANGE | 5,521 | 29.55% |
| RANGE | SWEEP | 3,720 | 19.91% |
| EXPANSION | RANGE | 3,683 | 19.71% |
| RANGE | EXPANSION | 2,170 | 11.61% |
| RANGE | DISPLACEMENT | 829 | 4.44% |
| RANGE | SHADOW_PENDING | 689 | 3.69% |
| EXPANSION | SWEEP | 466 | 2.49% |
| SWEEP | EXPANSION | 464 | 2.48% |
| DISPLACEMENT | RANGE | 294 | 1.57% |
| SWEEP | SHADOW_PENDING | 226 | 1.21% |
| RANGE | RETEST | 157 | 0.84% |
| EXPANSION | SHADOW_PENDING | 97 | 0.52% |
| EXPANSION | DISPLACEMENT | 90 | 0.48% |
| SWEEP | DISPLACEMENT | 77 | 0.41% |
| SHADOW_PENDING | RANGE | 48 | 0.26% |
| DISPLACEMENT | SWEEP | 47 | 0.25% |
| SWEEP | RETEST | 38 | 0.20% |
| DISPLACEMENT | EXPANSION | 20 | 0.11% |
| EXPANSION | RETEST | 15 | 0.08% |
| RETEST | RANGE | 14 | 0.07% |
| DISPLACEMENT | SHADOW_PENDING | 9 | 0.05% |
...
- Total disagreeing transition edges: **3,499**

| Engine from | Engine to | Resolver at bar | N |
|-------------|-----------|-----------------|---|
| RANGE | SWEEP | RANGE | 2,598 |
| SWEEP | DISPLACEMENT | RANGE | 279 |
| RANGE | SWEEP | EXPANSION | 226 |
| RANGE | SWEEP | DISPLACEMENT | 102 |
| RANGE | SWEEP | SHADOW_PENDING | 66 |
| SHADOW_PENDING | SWEEP | RANGE | 41 |
| SWEEP | EXPANSION | RANGE | 41 |
| RANGE | SHADOW_PENDING | RANGE | 39 |
| RANGE | SWEEP | RETEST | 18 |
| SWEEP | DISPLACEMENT | EXPANSION | 17 |
| EXPANSION | RETEST | RANGE | 16 |
| DISPLACEMENT | EXPANSION | RANGE | 14 |
| SWEEP | DISPLACEMENT | SWEEP | 12 |
| RANGE | SHADOW_PENDING | SWEEP | 9 |
| SWEEP | DISPLACEMENT | SHADOW_PENDING | 6 |
...
| 94 | 2024-05-23T20:00:00 | RANGE→SWEEP | DISPLACEMENT | Sweep @ 2339.76000 idx=94 |
