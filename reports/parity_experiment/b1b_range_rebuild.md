...
> Generated: 2026-08-05T13:09:08.595482
>
...
- Resolver lifecycle resets: HTF=**11,323** gap=**121** forced=**0**
...
|-------|----------|------------------|-----------|
| RANGE | 36,886 | 35,103 | 35,159 |
| SWEEP | 7,640 | 7,046 | 6,987 |
| DISPLACEMENT | 353 | 371 | 373 |
| EXPANSION | 1,890 | 4,604 | 4,605 |
| RETEST | 93 | 17 | 17 |
| EXECUTION | 0 | 5 | 5 |
| SHADOW_PENDING | 335 | 51 | 51 |

## Agreement

- **Exact bar match:** 29,310 / 47,197 (**62.10%**)
- **Mismatch bars:** 17,887 (37.90%)
...
|---------|------|------|------|------|------|------|------|---------|
| **RANGE** | **27673** | 5788 | 267 | 1065 | 68 | 0 | 242 | 35,103 |
| **SWEEP** | 5691 | **1044** | 29 | 224 | 10 | 0 | 48 | 7,046 |
| **DISPLACEMENT** | 285 | 69 | **5** | 11 | 0 | 0 | 1 | 371 |
| **EXPANSION** | 3176 | 732 | 52 | **587** | 15 | 0 | 42 | 4,604 |
| **RETEST** | 11 | 3 | 0 | 2 | **0** | 0 | 1 | 17 |
| **EXECUTION** | 4 | 1 | 0 | 0 | 0 | **0** | 0 | 5 |
| **SHADOW_PENDING** | 46 | 3 | 0 | 1 | 0 | 0 | **1** | 51 |

### Top off-diagonal confusions (engine → resolver mislabel)

| Engine | Resolver | N | % of mismatches |
|--------|----------|---|-----------------|
| RANGE | SWEEP | 5,788 | 32.36% |
| SWEEP | RANGE | 5,691 | 31.82% |
| EXPANSION | RANGE | 3,176 | 17.76% |
| RANGE | EXPANSION | 1,065 | 5.95% |
| EXPANSION | SWEEP | 732 | 4.09% |
| DISPLACEMENT | RANGE | 285 | 1.59% |
| RANGE | DISPLACEMENT | 267 | 1.49% |
| RANGE | SHADOW_PENDING | 242 | 1.35% |
| SWEEP | EXPANSION | 224 | 1.25% |
| DISPLACEMENT | SWEEP | 69 | 0.39% |
| RANGE | RETEST | 68 | 0.38% |
| EXPANSION | DISPLACEMENT | 52 | 0.29% |
| SWEEP | SHADOW_PENDING | 48 | 0.27% |
| SHADOW_PENDING | RANGE | 46 | 0.26% |
| EXPANSION | SHADOW_PENDING | 42 | 0.23% |
| SWEEP | DISPLACEMENT | 29 | 0.16% |
| EXPANSION | RETEST | 15 | 0.08% |
| RETEST | RANGE | 11 | 0.06% |
| DISPLACEMENT | EXPANSION | 11 | 0.06% |
| SWEEP | RETEST | 10 | 0.06% |
| EXECUTION | RANGE | 4 | 0.02% |
| SHADOW_PENDING | SWEEP | 3 | 0.02% |
| RETEST | SWEEP | 3 | 0.02% |
| RETEST | EXPANSION | 2 | 0.01% |
| SHADOW_PENDING | EXPANSION | 1 | 0.01% |
...
| 95 | 95 | 1 | SWEEP | RANGE | 1 |
| 98 | 102 | 5 | SWEEP | RANGE | 3 |
| 107 | 109 | 3 | SWEEP | RANGE | 3 |
| 123 | 124 | 2 | SWEEP | RANGE | 1 |
| 126 | 127 | 2 | RANGE | DISPLACEMENT | 1 |
| 129 | 129 | 1 | SHADOW_PENDING | RANGE | 1 |
| 140 | 146 | 7 | RANGE | SWEEP | 4 |
| 148 | 149 | 2 | SWEEP | RANGE | 2 |
| 152 | 152 | 1 | RANGE | SWEEP | 1 |
| 154 | 154 | 1 | RANGE | SWEEP | 1 |
| 156 | 157 | 2 | SWEEP | RANGE | 2 |
| 162 | 162 | 1 | RANGE | SWEEP | 1 |
| 168 | 168 | 1 | RANGE | SWEEP | 1 |
| 170 | 171 | 2 | RANGE | SWEEP | 1 |
| 174 | 174 | 1 | RANGE | SWEEP | 1 |
| 176 | 177 | 2 | SWEEP | RANGE | 2 |
| 180 | 182 | 3 | RANGE | SWEEP | 3 |
| 197 | 199 | 3 | SWEEP | DISPLACEMENT | 1 |
| 202 | 202 | 1 | RANGE | SWEEP | 1 |
| 204 | 205 | 2 | SWEEP | RANGE | 2 |
| 208 | 209 | 2 | SWEEP | RANGE | 2 |
| 216 | 218 | 3 | RANGE | SWEEP | 3 |
| 220 | 220 | 1 | SWEEP | RANGE | 1 |
| 222 | 226 | 5 | SWEEP | RANGE | 3 |
| 229 | 230 | 2 | RANGE | SWEEP | 2 |
| 234 | 234 | 1 | RANGE | SWEEP | 1 |
...
- Total disagreeing transition edges: **3,310**

| Engine from | Engine to | Resolver at bar | N |
|-------------|-----------|-----------------|---|
| RANGE | SWEEP | RANGE | 2,658 |
| SWEEP | DISPLACEMENT | RANGE | 278 |
| RANGE | SWEEP | EXPANSION | 108 |
| SHADOW_PENDING | SWEEP | RANGE | 39 |
| SWEEP | EXPANSION | RANGE | 39 |
| RANGE | SHADOW_PENDING | RANGE | 35 |
| RANGE | SWEEP | DISPLACEMENT | 31 |
| RANGE | SWEEP | SHADOW_PENDING | 23 |
| SWEEP | DISPLACEMENT | SWEEP | 23 |
| DISPLACEMENT | EXPANSION | RANGE | 14 |
| RANGE | SHADOW_PENDING | SWEEP | 13 |
| EXPANSION | RETEST | RANGE | 13 |
| SWEEP | DISPLACEMENT | EXPANSION | 11 |
| RANGE | SWEEP | RETEST | 5 |
| RETEST | EXECUTION | RANGE | 4 |
| EXPANSION | RETEST | EXPANSION | 2 |
| SWEEP | DISPLACEMENT | SHADOW_PENDING | 2 |
| SWEEP | EXPANSION | SWEEP | 2 |
| DISPLACEMENT | EXPANSION | SWEEP | 2 |
| EXPANSION | RETEST | SWEEP | 1 |
| EXECUTION | RESOLUTION | RANGE | 1 |
| RANGE | SHADOW_PENDING | EXPANSION | 1 |
| SHADOW_PENDING | SWEEP | EXPANSION | 1 |
| EXPANSION | RETEST | DISPLACEMENT | 1 |
| RETEST | EXECUTION | SWEEP | 1 |
...
| 391 | 2024-05-29T04:45:00 | RANGE→SWEEP | SHADOW_PENDING | Sweep @ 2355.92000 idx=391 |
