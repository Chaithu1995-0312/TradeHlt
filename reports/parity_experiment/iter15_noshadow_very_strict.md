...
> Generated: 2026-08-05T12:16:41.444174
>
...
| Resolver config | `reports\parity_experiment\iter15_noshadow_very_strict.yaml` |
...
- Resolver lifecycle resets: HTF=**11,777** gap=**121** forced=**0**
...
|-------|----------|------------------|-----------|
| RANGE | 40,494 | 35,103 | 35,159 |
| SWEEP | 6,610 | 7,046 | 6,987 |
| DISPLACEMENT | 49 | 371 | 373 |
| EXPANSION | 41 | 4,604 | 4,605 |
| RETEST | 3 | 17 | 17 |
| EXECUTION | 0 | 5 | 5 |
...
- **Exact bar match:** 30,894 / 47,197 (**65.46%**)
- **Mismatch bars:** 16,303 (34.54%)
...
|---------|------|------|------|------|------|------|------|---------|
| **RANGE** | **29978** | 5049 | 39 | 37 | 0 | 0 | 0 | 35,103 |
| **SWEEP** | 6120 | **916** | 3 | 4 | 3 | 0 | 0 | 7,046 |
| **DISPLACEMENT** | 319 | 52 | **0** | 0 | 0 | 0 | 0 | 371 |
| **EXPANSION** | 4009 | 588 | 7 | **0** | 0 | 0 | 0 | 4,604 |
...
|--------|----------|---|-----------------|
| SWEEP | RANGE | 6,120 | 37.54% |
| RANGE | SWEEP | 5,049 | 30.97% |
| EXPANSION | RANGE | 4,009 | 24.59% |
| EXPANSION | SWEEP | 588 | 3.61% |
| DISPLACEMENT | RANGE | 319 | 1.96% |
| DISPLACEMENT | SWEEP | 52 | 0.32% |
| SHADOW_PENDING | RANGE | 50 | 0.31% |
| RANGE | DISPLACEMENT | 39 | 0.24% |
| RANGE | EXPANSION | 37 | 0.23% |
| RETEST | RANGE | 15 | 0.09% |
| EXPANSION | DISPLACEMENT | 7 | 0.04% |
| SWEEP | EXPANSION | 4 | 0.02% |
| SWEEP | DISPLACEMENT | 3 | 0.02% |
...
- Total disagreeing transition edges: **3,332**

| Engine from | Engine to | Resolver at bar | N |
|-------------|-----------|-----------------|---|
| RANGE | SWEEP | RANGE | 2,833 |
| SWEEP | DISPLACEMENT | RANGE | 299 |
...
| RANGE | SWEEP | DISPLACEMENT | 4 |
| RANGE | SWEEP | EXPANSION | 4 |
