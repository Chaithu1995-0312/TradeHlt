...
> Generated: 2026-08-05T12:06:13.436232
>
...
| Resolver config | `reports\parity_experiment\iter2_loose_disp.yaml` |
...
- Resolver lifecycle resets: HTF=**11,369** gap=**121** forced=**0**
...
|-------|----------|------------------|-----------|
| RANGE | 38,669 | 35,103 | 35,159 |
| SWEEP | 5,701 | 7,046 | 6,987 |
| DISPLACEMENT | 594 | 371 | 373 |
| EXPANSION | 1,477 | 4,604 | 4,605 |
| RETEST | 138 | 17 | 17 |
| EXECUTION | 0 | 5 | 5 |
| SHADOW_PENDING | 618 | 51 | 51 |

## Agreement

- **Exact bar match:** 29,780 / 47,197 (**63.10%**)
- **Mismatch bars:** 17,417 (36.90%)
...
|---------|------|------|------|------|------|------|------|---------|
| **RANGE** | **28755** | 4333 | 497 | 1022 | 97 | 0 | 399 | 35,103 |
| **SWEEP** | 5796 | **807** | 39 | 225 | 29 | 0 | 150 | 7,046 |
| **DISPLACEMENT** | 300 | 50 | **1** | 14 | 0 | 0 | 6 | 371 |
| **EXPANSION** | 3752 | 506 | 57 | **216** | 12 | 0 | 61 | 4,604 |
| **RETEST** | 14 | 2 | 0 | 0 | **0** | 0 | 1 | 17 |
| **EXECUTION** | 3 | 2 | 0 | 0 | 0 | **0** | 0 | 5 |
| **SHADOW_PENDING** | 49 | 1 | 0 | 0 | 0 | 0 | **1** | 51 |

### Top off-diagonal confusions (engine → resolver mislabel)

| Engine | Resolver | N | % of mismatches |
|--------|----------|---|-----------------|
| SWEEP | RANGE | 5,796 | 33.28% |
| RANGE | SWEEP | 4,333 | 24.88% |
| EXPANSION | RANGE | 3,752 | 21.54% |
| RANGE | EXPANSION | 1,022 | 5.87% |
| EXPANSION | SWEEP | 506 | 2.91% |
| RANGE | DISPLACEMENT | 497 | 2.85% |
| RANGE | SHADOW_PENDING | 399 | 2.29% |
| DISPLACEMENT | RANGE | 300 | 1.72% |
| SWEEP | EXPANSION | 225 | 1.29% |
| SWEEP | SHADOW_PENDING | 150 | 0.86% |
| RANGE | RETEST | 97 | 0.56% |
| EXPANSION | SHADOW_PENDING | 61 | 0.35% |
| EXPANSION | DISPLACEMENT | 57 | 0.33% |
| DISPLACEMENT | SWEEP | 50 | 0.29% |
| SHADOW_PENDING | RANGE | 49 | 0.28% |
| SWEEP | DISPLACEMENT | 39 | 0.22% |
| SWEEP | RETEST | 29 | 0.17% |
| RETEST | RANGE | 14 | 0.08% |
| DISPLACEMENT | EXPANSION | 14 | 0.08% |
| EXPANSION | RETEST | 12 | 0.07% |
...
- Total disagreeing transition edges: **3,425**

| Engine from | Engine to | Resolver at bar | N |
|-------------|-----------|-----------------|---|
| RANGE | SWEEP | RANGE | 2,708 |
| SWEEP | DISPLACEMENT | RANGE | 284 |
| RANGE | SWEEP | EXPANSION | 111 |
| RANGE | SWEEP | DISPLACEMENT | 65 |
| SHADOW_PENDING | SWEEP | RANGE | 42 |
| SWEEP | EXPANSION | RANGE | 42 |
| RANGE | SHADOW_PENDING | RANGE | 40 |
| RANGE | SWEEP | SHADOW_PENDING | 38 |
| EXPANSION | RETEST | RANGE | 16 |
| DISPLACEMENT | EXPANSION | RANGE | 15 |
| SWEEP | DISPLACEMENT | SWEEP | 14 |
| RANGE | SWEEP | RETEST | 13 |
| SWEEP | DISPLACEMENT | EXPANSION | 11 |
| RANGE | SHADOW_PENDING | SWEEP | 10 |
| SWEEP | DISPLACEMENT | SHADOW_PENDING | 5 |
...
| DISPLACEMENT | EXPANSION | SHADOW_PENDING | 1 |
