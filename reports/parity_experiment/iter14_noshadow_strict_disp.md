...
> Generated: 2026-08-05T12:16:05.575398
>
...
| Resolver config | `reports\parity_experiment\iter14_noshadow_strict_disp.yaml` |
...
- Resolver lifecycle resets: HTF=**11,634** gap=**121** forced=**0**
...
|-------|----------|------------------|-----------|
| RANGE | 40,016 | 35,103 | 35,159 |
| SWEEP | 6,330 | 7,046 | 6,987 |
| DISPLACEMENT | 248 | 371 | 373 |
| EXPANSION | 570 | 4,604 | 4,605 |
| RETEST | 33 | 17 | 17 |
| EXECUTION | 0 | 5 | 5 |
...
- **Exact bar match:** 30,731 / 47,197 (**65.11%**)
- **Mismatch bars:** 16,466 (34.89%)
...
|---------|------|------|------|------|------|------|------|---------|
| **RANGE** | **29697** | 4824 | 205 | 352 | 25 | 0 | 0 | 35,103 |
| **SWEEP** | 6056 | **893** | 17 | 72 | 8 | 0 | 0 | 7,046 |
| **DISPLACEMENT** | 315 | 51 | **1** | 4 | 0 | 0 | 0 | 371 |
| **EXPANSION** | 3882 | 557 | 25 | **140** | 0 | 0 | 0 | 4,604 |
| **RETEST** | 14 | 2 | 0 | 1 | **0** | 0 | 0 | 17 |
| **EXECUTION** | 3 | 2 | 0 | 0 | 0 | **0** | 0 | 5 |
| **SHADOW_PENDING** | 49 | 1 | 0 | 1 | 0 | 0 | **0** | 51 |

### Top off-diagonal confusions (engine → resolver mislabel)

| Engine | Resolver | N | % of mismatches |
|--------|----------|---|-----------------|
| SWEEP | RANGE | 6,056 | 36.78% |
| RANGE | SWEEP | 4,824 | 29.30% |
| EXPANSION | RANGE | 3,882 | 23.58% |
| EXPANSION | SWEEP | 557 | 3.38% |
| RANGE | EXPANSION | 352 | 2.14% |
| DISPLACEMENT | RANGE | 315 | 1.91% |
| RANGE | DISPLACEMENT | 205 | 1.24% |
| SWEEP | EXPANSION | 72 | 0.44% |
| DISPLACEMENT | SWEEP | 51 | 0.31% |
| SHADOW_PENDING | RANGE | 49 | 0.30% |
| EXPANSION | DISPLACEMENT | 25 | 0.15% |
| RANGE | RETEST | 25 | 0.15% |
| SWEEP | DISPLACEMENT | 17 | 0.10% |
| RETEST | RANGE | 14 | 0.09% |
| SWEEP | RETEST | 8 | 0.05% |
| DISPLACEMENT | EXPANSION | 4 | 0.02% |
...
| SWEEP | DISPLACEMENT | EXPANSION | 3 |
| RANGE | SWEEP | RETEST | 3 |
